...
def main() -> None:
    ...
    parser.add_argument("--data-dir", default="../data", help="Destination directory for CT files")
    parser.add_argument("--labels-dir", default="../labels", help="Destination directory for PET files")
    parser.add_argument("--segs-dir", default="../segs", help="Destination directory for SEG files")
